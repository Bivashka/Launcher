...
namespace BivLauncher.Api.Data.Migrations
{
    ...
    [Migration("20260408132106_PersistDeliverySettingsState")]
    partial class PersistDeliverySettingsState
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BivLauncher.Api.Data.Entities.ActiveGameSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DeviceUserName");

                    b.HasIndex("ExpiresAtUtc");

                    b.HasIndex("HwidHash");

                    b.ToTable("ActiveGameSessions");
                });
            ...
            modelBuilder.Entity("BivLauncher.Api.Data.Entities.DeliverySettingsState", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");

                    b.Property<string>("AssetBaseUrl")
                        .IsRequired()
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");

                    b.Property<string>("AssetBaseUrlEu")
                        .IsRequired()
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");

                    b.Property<string>("AssetBaseUrlRu")
                        .IsRequired()
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");

                    b.Property<string>("FallbackApiBaseUrlsEuJson")
                        .IsRequired()
                        .HasMaxLength(16384)
                        .HasColumnType("character varying(16384)");

                    b.Property<string>("FallbackApiBaseUrlsJson")
                        .IsRequired()
                        .HasMaxLength(16384)
                        .HasColumnType("character varying(16384)");

                    b.Property<string>("FallbackApiBaseUrlsRuJson")
                        .IsRequired()
                        .HasMaxLength(16384)
                        .HasColumnType("character varying(16384)");

                    b.Property<string>("LauncherApiBaseUrlEu")
                        .IsRequired()
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");

                    b.Property<string>("LauncherApiBaseUrlRu")
                        .IsRequired()
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");
                    ...
                    b.Property<string>("PublicBaseUrlEu")
                        .IsRequired()
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");

                    b.Property<string>("PublicBaseUrlRu")
                        .IsRequired()
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");
                    ...
                    b.ToTable("DeliverySettingsStates");
                });
            ...
            modelBuilder.Entity("BivLauncher.Api.Data.Entities.Profile", b =>
                {
                    ...
                    b.Property<string>("AllowedPlayerUsernames")
                        .IsRequired()
                        .HasMaxLength(4096)
                        .HasColumnType("character varying(4096)");
            ...
            modelBuilder.Entity("BivLauncher.Api.Data.Entities.SecuritySettingsState", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");

                    b.Property<int>("GameSessionExpirationSeconds")
                        .HasColumnType("integer");

                    b.Property<int>("GameSessionHeartbeatIntervalSeconds")
                        .HasColumnType("integer");

                    b.Property<string>("LauncherAdminUsernamesJson")
                        .IsRequired()
                        .HasMaxLength(8192)
                        .HasColumnType("character varying(8192)");

                    b.Property<int>("MaxConcurrentGameAccountsPerDevice")
                        .HasColumnType("integer");

                    b.Property<string>("SiteCosmeticsUploadSecret")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.ToTable("SecuritySettingsStates");
                });
