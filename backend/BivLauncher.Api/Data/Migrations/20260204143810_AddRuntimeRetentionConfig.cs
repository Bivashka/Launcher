...
{
    /// <inheritdoc />
    public partial class AddRuntimeRetentionConfig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "RuntimeRetentionConfigs",
                columns: table => new
                {
                    ...
                    LastProfilesProcessed = table.Column<int>(type: "integer", nullable: false),
                    LastRunError = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RuntimeRetentionConfigs", x => x.Id);
                });
        }
