...
public static class LauncherLocalization
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations = new(StringComparer.OrdinalIgnoreCase)
    {
        ["ru"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["status.twoFactorRequired"] = "Введите код 2FA из приложения.",
            ["status.twoFactorSetupSecret"] = "2FA не настроена. Добавьте ключ в приложение: {0}",
            ["status.twoFactorSetup"] = "2FA не настроена. Ключ: {0}. URI: {1}",
            ["status.loggedInAs"] = "Вход выполнен: {0} ({1})",
            ["status.error"] = "Ошибка: {0}",
            ["status.rateLimited"] = "Too many requests. Retry shortly.",
            ["status.rateLimitedRetry"] = "Too many requests. Retry in {0} second(s).",
            ...
            ["button.login"] = "Войти",
            ["button.verifyTwoFactor"] = "Подтвердить 2FA",
        ...
        ["en"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["status.twoFactorRequired"] = "Enter your 2FA app code.",
            ["status.twoFactorSetupSecret"] = "2FA is not enrolled yet. Add this key to your app: {0}",
            ["status.twoFactorSetup"] = "2FA is not enrolled yet. Key: {0}. URI: {1}",
            ...
            ["button.login"] = "Login",
            ["button.verifyTwoFactor"] = "Verify 2FA",
        ...
        ["uk"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["status.twoFactorRequired"] = "Введіть код 2FA із застосунку.",
            ["status.twoFactorSetupSecret"] = "2FA ще не налаштовано. Додайте ключ у застосунок: {0}",
            ["status.twoFactorSetup"] = "2FA ще не налаштовано. Ключ: {0}. URI: {1}",
            ...
            ["button.login"] = "Увійти",
            ["button.verifyTwoFactor"] = "Підтвердити 2FA",
        ...
        ["kk"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["status.authorizing"] = "Авторизация...",
            ["status.twoFactorRequired"] = "Қосымшадағы 2FA кодын енгізіңіз.",
            ["status.twoFactorSetupSecret"] = "2FA әлі бапталмаған. Осы кілтті қосымшаға қосыңыз: {0}",
            ["status.twoFactorSetup"] = "2FA әлі бапталмаған. Кілт: {0}. URI: {1}",
            ...
            ["button.login"] = "Кіру",
            ["button.verifyTwoFactor"] = "2FA растау",
